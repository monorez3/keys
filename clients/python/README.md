...
трата делится на всех, кто упомянут.

Поля ответа: `transfers`, `transfers_count`, `naive_count`, `balances`,
...
| Аргумент | По умолчанию | Что делает |
| --- | --- | --- |
| `value` | — | главное значение: ссылка для `alive`, список трат для `settle` |
